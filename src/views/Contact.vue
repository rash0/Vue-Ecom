    ...
    <section>
      <div class="container-fluid py-5">
        <div class="row d-flex">
          <div class="col-12 col-xl-6 col-lg-6 col-md-12 col-sm-12 order-sm-0 order-12" style="margin-left:-50px;">
            <img class="img-fluid" src="@/assets/con.jpg">
          </div>
          <div class="col-12 col-xl-6 col-lg-12 col-md-12 col-sm-12 order-first order-xl-0">
            <h1>Hello there</h1>
