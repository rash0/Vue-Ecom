  ...
  <div>
    <div :class="['cart', cart.isOpen ? 'on' : '']">
      <div class="cart-menu">
        ...
        <div class="row" v-for="thing in store.cartItems" v-bind:key="thing.id">
          <div class="col4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
            <img :src="useAsset(thing.img)" style="width: 90px;">
          </div>
          ...
          <div class="col2 col-xl-2 col-lg-2 col-md-2 col-sm-2 pt-4">
            <span class="remove-btn" @click="store.outCart(thing.id)">remove</span>
          </div>
        </div>
